...
import ProductGrid from "@/components/reusable/ProductGrid"; // adjust import path

const ITEMS_PER_PAGE = 6;

function CategoryProducts({ priceRange, category, products }: any) {
  ...
  const paginatedProducts: any[] = useMemo(() => {
