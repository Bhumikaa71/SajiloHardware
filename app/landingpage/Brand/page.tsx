      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-5 relative z-10">
        {brands.map((brand, index) => (
          <Link
            key={index}
            href="/category"
            className="group bg-white rounded-2xl border border-gray-200 p-4 flex flex-col items-center justify-center shadow-sm hover:shadow-lg hover:-translate-y-1 transition duration-300"
          >
